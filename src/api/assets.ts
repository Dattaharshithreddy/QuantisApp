...
export const ASSETS: LogicalAsset[] = [
  ...
  { id: 'BTC', name: 'Bitcoin', type: 'CRYPTO', defaultExchange: 'binance',
    exchanges: {
      ...
      coindcx_futures: { src:'coindcx_futures', symbol:'BTC-PERP-CDX', cdxSym:'B-BTC_USDT', cdxMkt:'BTCUSDT', base:67420, vol:0.028 },
    } },
  ...
  { id: 'ETH', name: 'Ethereum', type: 'CRYPTO', defaultExchange: 'binance',
    exchanges: {
      ...
      coindcx_futures: { src:'coindcx_futures', symbol:'ETH-PERP-CDX', cdxSym:'B-ETH_USDT', cdxMkt:'ETHUSDT', base:3485, vol:0.032 },
    } },
