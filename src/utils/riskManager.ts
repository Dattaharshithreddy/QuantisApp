...
const DEFAULT_SETTINGS: RiskSettings = { accountSize: 100000, riskPerTradePct: 1, maxDailyLossPct: 3 };
...
export async function getTodayPnL(): Promise<DailyPnL> {
  ...
  return raw ? JSON.parse(raw) : { date: today, realizedPnL: 0, tradesCount: 0 };
}
